/*********************************************************************
 ** Program Filename: buffet.cpp (Final Assignment)
...
void Buffet::special(){
    std::cout << "The stench of rotting food is nearly overpowering. It seems as though the ship has been abandoned for quite awhile. There appears to be a way out in direction 1." << std::endl;
}
